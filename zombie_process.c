// C program that illustrated the concept of a
// zombie process in operatins systems. A process
// which has terminated execution but still has an entry
// in the process table is called a zombie process. 
